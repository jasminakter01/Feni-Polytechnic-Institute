...
public class Itihas_Layout extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    DrawerLayout drawerLayout;
    ActionBarDrawerToggle toggle;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_itihas__layout);
        this.setTitle(R.string.ff1);
        drawerLayout=findViewById(R.id.litihasid);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (menuItem.getItemId()==R.id.suchona){
          ...
          intent=new Intent(getApplicationContext(),Obosthan_Layout.class);
            ...
            intent=new Intent(Itihas_Layout.this,Itihas_Layout.class);
            startActivity(intent);
